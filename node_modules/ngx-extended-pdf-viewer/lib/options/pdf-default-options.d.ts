...
export declare const pdfjsVersion = "5.4.1100";
export declare const pdfjsBleedingEdgeVersion = "5.4.1101";
...
export declare function isBleedingEdge(): boolean;
...
export declare const pdfDefaultOptions: {
    ...
    passwordPrompt: any;
    enableHWA: boolean;
    positionPopupDialogsWithJavaScript: boolean;
